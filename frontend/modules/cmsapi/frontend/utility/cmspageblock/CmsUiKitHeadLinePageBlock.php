...
/**
 * Description of CmsUiKitHeadLinePageBlock
 *
 * 
 */
class CmsUiKitHeadLinePageBlock extends CmsPageBlock
{
    ...
    public function buildValues(PostCmsCreatePage $postCmsPage)
    {
        ...
        $text      = isset($valuesCfg['first_content']) ? $valuesCfg['first_content']
                : (isset($values['content']) ? $values['content'] : "");
    ...
    {
        $id_block = static::findBlock(CmsBlocksBuilder::UIKITHEADLINE);
        $blocks   = static::find()->
