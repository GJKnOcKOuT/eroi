...
// Color
if ($data['slidenav'] == 'outside' && ($data['text_color'] != $data['slidenav_outside_color'])) {
    if (!$data['text_color']) {
        ...
        $attrs_slidenav_container['uk-toggle'] = "cls: js-color-state uk-{$data['text_color']}; mode: media; media: @{$data['slidenav_outside_breakpoint']}";
        $attrs_slidenav_container['class'][] = "js-color-state";
    } else {
        $attrs_slidenav_container['uk-toggle'] = "cls: uk-{$data['slidenav_outside_color']} uk-{$data['text_color']}; mode: media; media: @{$data['slidenav_outside_breakpoint']}";
        $attrs_slidenav_container['class'][] = "uk-{$data['slidenav_outside_color']}";
    }
} else {
    $attrs_slidenav_container['class'][] = $data['text_color'] ? "uk-{$data['text_color']}" : '';
}
?>
