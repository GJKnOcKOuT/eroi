    ...
    $.fn.lightSlider = function (options) {
            ...
            pager: function () {
                ...
                refresh.createPager = function () {
                    ...
                    if (settings.gallery === true) {
                        ...
                        $cSouter.find('.lSPager').css(property, 'auto'/*pagerWidth + 'px'*/);
                    }
        ...
        $el.goToPrevSlide = function () {
            if (scene > 0) {
                ...
                if (settings.loop === true) {
                    ...
                    if (settings.mode === 'fade') {
                        var l = (length - 1);
                        var temp1 = parseInt(l);
                        var temp2 = parseInt(settings.slideMove);
                        scene = (temp1 / temp2);
                    }
                    $el.mode(false);
                    if (settings.gallery === true) {
        ...
        $(window).on('resize orientationchange', function (e) {
            setTimeout(function () {
                ...
                var windowHeight = $(window).height() /*- $('.nav-container').outerHeight()*/;
                ...
                if($(window).height() > 325) { //TODO REMOVE, TEST WITH HEIGHT 100VH
                    ...
                    $('.lSSlideOuter').css('height', windowHeight + 'px');
                }
            }, 200);
        });
        return this;
