...
class DefaultController extends Controller
{
    ...
    public function actionIndex(array $parms)
    {
        ...
        if (class_exists($backendModule) && in_array('arter\amos\core\interfaces\CmsModuleInterface',
                class_implements($backendModule))) {
            $modelSearchClass = $backendModule::getModelSearchClassName();

            if (class_exists($modelSearchClass) && in_array('arter\amos\core\interfaces\CmsModelInterface',
                                 ...
                                 $relatedDitailPage = false)
    {
        ...
        $model = \arter\amos\seo\AmosSeo::getModelFromPrettyUrl($slug);
