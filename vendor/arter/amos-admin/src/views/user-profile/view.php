...
\arter\amos\admin\assets\AmosAsset::register($this);
    ...
    <div class="col-xs-12 info-view-header nop">
        ...
        <div class="col-md-9 col-sm-8 col-xs-12">
            ...
            <section class="wrap-details">
                ...
                <?php
                if(class_exists('\arter\amos\community\models\CommunityUserField')){
            ...
            <?php if ($enableUserContacts && Yii::$app->user->id != $model->user_id && !$hideContactsInView): ?>
                <?= \arter\amos\admin\widgets\ConnectToUserWidget::widget([
                    'model' => $model,
                    'isProfileView' => true,
    ...
    <div class="col-xs-12 nop info-view-body">
        <div class="col-md-8 col-xs-12">
            ...
            if ($enableUserContacts && $model->validato_almeno_una_volta && !$hideContactsInView) {
                $accordionUserContacts = \arter\amos\admin\widgets\UserContacsWidget::widget([
            ...
            if (isset($moduleCwh)) {
                $accordionNetwork = \arter\amos\cwh\widgets\UserNetworkWidget::widget([
                    'userId' => $model->user_id,
                    'isUpdate' => false
                ]);
            ...
            <?php if (Yii::$app->user->can('PRIVILEGES_MANAGER')) {
                ...
                if (!empty($privilegesModule)) {
                    $accordionAdmin = \arter\amos\privileges\widgets\UserPrivilegesWidget::widget(['userId' => $model->user_id]);
                }
