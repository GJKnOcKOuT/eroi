...
use arter\amos\admin\models\DropAccountForm;
 ...
 * @package arter\amos\admin\controllers
 */
class UserProfileController extends \arter\amos\admin\controllers\base\UserProfileController
{
    /**
     * @var string $layout
     */
    ...
    {
        /** @var \arter\amos\cwh\AmosCwh $cwh */
        ...
        if (isset($cwh)) {
            ...
            if (!empty($cwh->userEntityRelationTable)) {
                ...
                $network                             = \arter\amos\cwh\models\CwhConfig::findOne(['tablename' => $entity]);
                if (!empty($network)) {
...
//        }
    ...
    public function actionDeactivateAccount($id)
    {
        ...
        $subjectView = '@vendor/arter/amos-admin/src/mail/user/deactivateaccount-subject';
        $contentView = '@vendor/arter/amos-admin/src/mail/user/deactivateaccount-html';
