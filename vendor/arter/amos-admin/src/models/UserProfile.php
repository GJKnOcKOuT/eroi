...
use arter\amos\admin\events\AdminWorkflowEvent;
use arter\amos\admin\events\AssociateTutorToUserEvent;
use arter\amos\admin\i18n\grammar\UserProfileGrammar;
use arter\amos\admin\models\base\UserProfile as BaseUserProfile;
...
use arter\amos\core\interfaces\FacilitatorInterface;
 ...
 * @property \arter\amos\comuni\models\IstatComuni $residenzaComune
 * @property \arter\amos\comuni\models\IstatProvince $residenzaProvincia
 * @property \arter\amos\core\interfaces\OrganizationsModelInterface $userOrganization
...
class UserProfile extends BaseUserProfile implements ContentModelInterface, ViewModelInterface, FacilitatorInterface
{
    ...
    /**
     * @var \arter\amos\attachments\models\File $userProfileImage
     */
    ...
    public function behaviors()
    {
        ...
        if (isset($cwhModule) && isset($tagModule)) {
            $cwhTaggable = ['interestingTaggable' => [
                'class' => \arter\amos\cwh\behaviors\TaggableInterestingBehavior::className(),
...
//            }
            if ($variazioniIndirizzo = $this->getDirtyAttributes($domicilioAttributes)) {
                ...
                if ($Comune && $Provincia && $googleMapsKey) {
                    ...
                    //$UrlGeocoder = "http://utility.arter.it/geo/geo/getcoords?indirizzo=$GeoCoderParams";
...
//    }
     ...
     * @return bool|\arter\amos\attachments\models\File|null|string
     */
