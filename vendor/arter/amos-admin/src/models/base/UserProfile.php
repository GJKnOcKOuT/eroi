 ...
 *
 * @property \arter\amos\comuni\models\IstatComuni $comuneResidenza
 * @property \arter\amos\comuni\models\IstatProvince $provinciaResidenza
 * @property \arter\amos\comuni\models\IstatComuni $domicilioComune
 * @property \arter\amos\comuni\models\IstatComuni $nascitaComuni
 * @property \arter\amos\comuni\models\IstatProvince $domicilioProvincia
 * @property \arter\amos\comuni\models\IstatProvince $nascitaProvince
 * @property \arter\amos\comuni\models\IstatNazioni $nascitaNazioni
 * @property \arter\amos\admin\models\UserProfile $facilitatore
 ...
 * @property \arter\amos\admin\models\UserProfileAgeGroup $userProfileAgeGroup
 * @property \arter\amos\organizzazioni\models\Profilo|\openinnovation\organizations\models\Organizations|\arter\amos\admin\interfaces\OrganizationsModuleInterface $prevalentPartnership
 * @property \arter\amos\core\user\User $user
 *
 * @property \arter\amos\socialauth\models\SocialAuthUsers[] $socialAuthUsers
 */
    ...
    public function rules()
    {
        ...
        $rules = [
            ...
            [['user_profile_role_other'], 'required', 'when' => function ($model) {
                return ($this->user_profile_role_id == \arter\amos\admin\models\UserProfileRole::OTHER);
            }, 'whenClient' => "function (attribute, value) {
                return ($('#" . Html::getInputId($this, 'user_profile_role_id') . "').val() == " . \arter\amos\admin\models\UserProfileRole::OTHER . ");
            }"],
            [['user_profile_area_other'], 'required', 'when' => function ($model) {
                return ($this->user_profile_area_id == \arter\amos\admin\models\UserProfileArea::OTHER);
            }, 'whenClient' => "function (attribute, value) {
                return ($('#" . Html::getInputId($this, 'user_profile_area_id') . "').val() == " . \arter\amos\admin\models\UserProfileArea::OTHER . ");
            }"],
...
//    }
    ...
    {
        return $this->hasMany(\arter\amos\tag\models\Tag::className(), ['id' => 'tag_id'])->viaTable('user_profile_tag_mm', ['user_profile_id' => 'id']);
    }
    ...
    {
        return $this->hasOne(\arter\amos\admin\models\UserProfileAgeGroup::className(), ['id' => 'user_profile_age_group_id']);
    }
    ...
    {
        return $this->hasOne(\arter\amos\admin\models\UserProfileReactivationRequest::className(), ['user_profile_id' => 'id']);
    }
    ...
    public function getSocialAuthUsers()
    {
        ...
        if (!is_null($socialAuth)) {
            $socialUserQuery = $this->hasMany(\arter\amos\socialauth\models\SocialAuthUsers::className(), ['user_id' => 'user_id']);
        }
    ...
    public function getUserProfileExternalFacilitator(){
        return $this->hasOne(\arter\amos\admin\models\UserProfileExternalFacilitator::className(), ['user_profile_id' => 'id'])->orderBy('id DESC');
    }
