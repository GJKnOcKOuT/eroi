 ...
 *
 * @property \arter\amos\partnershipprofiles\models\ExpressionsOfInterest[] $expressionsOfInterest
 * @property \arter\amos\partnershipprofiles\models\ExpressionsOfInterest[] $draftExpressionsOfInterest
 * @property \arter\amos\partnershipprofiles\models\ExpressionsOfInterest[] $activeExpressionsOfInterest
 * @property \arter\amos\partnershipprofiles\models\ExpressionsOfInterest[] $toValidateExpressionsOfInterest
 * @property \arter\amos\partnershipprofiles\models\ExpressionsOfInterest[] $relevantExpressionsOfInterest
 * @property \arter\amos\partnershipprofiles\models\ExpressionsOfInterest[] $rejectedExpressionsOfInterest
 * @property \arter\amos\partnershipprofiles\models\ExpressionsOfInterest[] $notDraftExpressionsOfInterest
 * @property \arter\amos\partnershipprofiles\models\WorkLanguage $workLanguage
 * @property \arter\amos\partnershipprofiles\models\DevelopmentStage $developmentStage
 * @property \arter\amos\partnershipprofiles\models\IntellectualProperty $intellectualProperty
 * @property \arter\amos\partnershipprofiles\models\PartnershipProfilesTypesMm[] $partnershipProfilesTypesMms
 * @property \arter\amos\partnershipprofiles\models\PartnershipProfilesCountriesMm[] $partnershipProfilesCountriesMms
 * @property \arter\amos\partnershipprofiles\models\PartnershipProfilesType[] $partnershipProfilesTypes
 * @property \arter\amos\comuni\models\IstatNazioni[] $partnershipProfileCountries
 * @property \arter\amos\admin\models\UserProfile $partnershipProfileFacilitator
 * @property \arter\amos\community\models\Community $community
 * @property \arter\amos\community\models\CommunityUserMm[] $communityUserMm
 *
 * @package arter\amos\partnershipprofiles\models\base
 */
abstract class PartnershipProfiles extends ContentModel implements CommunityInterface
{
    ...
    {
        return $this->hasOne(\arter\amos\partnershipprofiles\models\WorkLanguage::className(), ['id' => 'work_language_id']);
    }
    ...
    {
        return $this->hasOne(\arter\amos\partnershipprofiles\models\DevelopmentStage::className(), ['id' => 'development_stage_id']);
    }
    ...
    {
        return $this->hasOne(\arter\amos\partnershipprofiles\models\IntellectualProperty::className(), ['id' => 'intellectual_property_id']);
    }
    ...
    {
        return $this->hasMany(\arter\amos\partnershipprofiles\models\PartnershipProfilesTypesMm::className(), ['partnership_profile_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\arter\amos\partnershipprofiles\models\PartnershipProfilesType::className(), ['id' => 'partnership_profiles_type_id'])->via('partnershipProfilesTypesMms');
    }
    ...
    {
        return $this->hasMany(\arter\amos\partnershipprofiles\models\PartnershipProfilesCountriesMm::className(), ['partnership_profile_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\arter\amos\comuni\models\IstatNazioni::className(), ['id' => 'country_id'])->via('partnershipProfilesCountriesMms');
    }
    ...
    {
        return $this->hasMany($this->partnerProfModule->model('ExpressionsOfInterest'), ['partnership_profile_id' => 'id'])
            ->andWhere([\arter\amos\partnershipprofiles\models\ExpressionsOfInterest::tableName() . '.status' => \arter\amos\partnershipprofiles\models\ExpressionsOfInterest::EXPRESSIONS_OF_INTEREST_WORKFLOW_STATUS_DRAFT]);
    }
    ...
    {
        return $this->hasMany($this->partnerProfModule->model('ExpressionsOfInterest'), ['partnership_profile_id' => 'id'])
            ->andWhere([\arter\amos\partnershipprofiles\models\ExpressionsOfInterest::tableName() . '.status' => \arter\amos\partnershipprofiles\models\ExpressionsOfInterest::EXPRESSIONS_OF_INTEREST_WORKFLOW_STATUS_TOVALIDATE]);
    }
    ...
    {
        return $this->hasMany($this->partnerProfModule->model('ExpressionsOfInterest'), ['partnership_profile_id' => 'id'])
            ->andWhere([\arter\amos\partnershipprofiles\models\ExpressionsOfInterest::tableName() . '.status' => \arter\amos\partnershipprofiles\models\ExpressionsOfInterest::EXPRESSIONS_OF_INTEREST_WORKFLOW_STATUS_RELEVANT]);
    }
    ...
    {
        return $this->hasMany($this->partnerProfModule->model('ExpressionsOfInterest'), ['partnership_profile_id' => 'id'])
            ->andWhere([\arter\amos\partnershipprofiles\models\ExpressionsOfInterest::tableName() . '.status' => \arter\amos\partnershipprofiles\models\ExpressionsOfInterest::EXPRESSIONS_OF_INTEREST_WORKFLOW_STATUS_REJECTED]);
    }
    ...
    {
        return $this->hasMany(\arter\amos\community\models\CommunityUserMm::className(), ['community_id' => 'community_id']);
    }
}
