...
use arter\amos\partnershipprofiles\i18n\grammar\PartnershipProfilesGrammar;
 ...
 * @package arter\amos\partnershipprofiles\models
 */
class PartnershipProfiles extends \arter\amos\partnershipprofiles\models\base\PartnershipProfiles implements ViewModelInterface, FacilitatorInterface
{
    ...
    public function expressionOfInterestAllowed($allowedPartnershipProfileIds = null)
    {
		...
		$userProfileClass = \arter\amos\admin\AmosAdmin::instance()->createModel('UserProfile');
    ...
    /**
     * For this entity the validation logic is different from arter\amos\core\record\Record
