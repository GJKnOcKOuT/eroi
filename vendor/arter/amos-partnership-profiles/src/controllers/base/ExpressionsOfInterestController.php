...
use arter\amos\partnershipprofiles\events\PartnershipProfilesWorkflowEvent;
 ...
 *
 * @property \arter\amos\partnershipprofiles\models\ExpressionsOfInterest $model
 * @property \arter\amos\partnershipprofiles\models\search\ExpressionsOfInterestSearch $modelSearch
 *
 * @package arter\amos\partnershipprofiles\controllers\base
 */
    ...
    public function actionCreate($partnership_profile_id = null)
    {
        ...
        if ($this->model->load(Yii::$app->request->post())) {
            ...
            if (!is_null($moduleCwh)) {
                ...
                $cwhConfig = \arter\amos\cwh\models\CwhConfig::findOne(['tablename' => $splitUserNetworkReference[0]]);
