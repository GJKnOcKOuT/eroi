...
use arter\amos\emailmanager\interfaces\ManagerInterface;
...
use arter\amos\emailmanager\models\File;
use arter\amos\emailmanager\transports\YiiMailer;
use Mustache_Engine;
use Yii;
...
class AmosEmailManager implements ManagerInterface
{
     ...
     *
     * @param array $files
     * @return \arter\amos\emailmanager\base\File
     */
