 ...
 *
 * @property \arter\amos\een\models\EenPartnershipProposal $eenPartnershipProposal
 * @property \arter\amos\een\models\eenExprOfInterestHistory $eenExprOfInterestHistory
 * @property \arter\amos\core\user\User $user
 */
class EenExprOfInterest extends \arter\amos\core\record\Record
{
    ...
    {
        return [[['company_organization', 'address', 'city', 'postal_code',  'contact_person', 'phone', 'email', 'sector','technology_interest', 'organization_presentation', 'information_request'], 'required'],
            ...
            [['een_partnership_proposal_id'], 'exist', 'skipOnError' => true, 'targetClass' => \arter\amos\een\models\EenPartnershipProposal::className(), 'targetAttribute' => ['een_partnership_proposal_id' => 'id']],
...
//            [['sub_status'], 'required', 'on' => self::SCENARIO_STAFF_EEN]
    ...
    public function attributeLabels()
    {
        return [
            ...
            'een_network_node_id' => AmosEen::t('amoseen', 'In quale regione operi?'),
            ...
            'technology_interest' => AmosEen::t('amoseen', 'What kind of cooperation are you looking for?'),
            'organization_presentation' => AmosEen::t('amoseen', 'Some facts about your company'),
            'information_request' => AmosEen::t('amoseen', 'Which information is missing or unclear?'),
            'privacy' => AmosEen::t('amoseen', 'Privacy'),
            'privacy_info' => AmosEen::t('amoseen', 'Privacy'),
            'status' => AmosEen::t('amoseen', 'Status'),
            'sub_status' => AmosEen::t('amoseen', 'Sub-status'),
            'know_een' =>  AmosEen::t('amoseen', 'Conosci già i servizi di Enterprise Europe Network?'),
    ...
    {
        return $this->hasOne(\arter\amos\een\models\EenPartnershipProposal::className(), ['id' => 'een_partnership_proposal_id']);
    }
    ...
    {
        return $this->hasOne(\arter\amos\een\models\EenStaff::className(), ['id' => 'een_staff_id']);
    }
    ...
    {
        return $this->hasMany(\arter\amos\een\models\EenExprOfInterestHistory::className(), ['een_expr_of_interest_id' => 'id']);
    }
