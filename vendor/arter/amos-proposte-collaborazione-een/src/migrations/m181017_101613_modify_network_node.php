 ...
 */
class m181017_101613_modify_network_node extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->update('een_network_node', ['name' => "Abruzzo / Molise / Puglia / Basilicata / Calabria / Sicilia / Campania (BRIDG€CONOMIES)"], ['id' => 6]);
