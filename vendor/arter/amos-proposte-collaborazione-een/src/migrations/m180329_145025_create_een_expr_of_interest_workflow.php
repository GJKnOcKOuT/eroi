...
class m180329_145025_create_een_expr_of_interest_workflow extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->insert(self::TABLE_WORKFLOW_METADATA,
            [
                'status_id' => 'SUSPENDED',
                'workflow_id' =>  \arter\amos\een\models\EenExprOfInterest::EEN_EXPR_OF_INTEREST_WORKFLOW,
                'key' => 'buttonLabel',
                'value' => 'Suspend',
            ]);
    ...
    private function setNewConfigurations()
    {
        $this->eenConf = [
            [
                'id' => \arter\amos\een\models\EenExprOfInterest::EEN_EXPR_OF_INTEREST_WORKFLOW,
