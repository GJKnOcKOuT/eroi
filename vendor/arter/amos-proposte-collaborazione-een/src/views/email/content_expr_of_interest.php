...
//                }
                ?>
                <?=AmosEen::t('amoseen',
                "Ti confermiamo che la tua manifestazione di interesse relativa al profilo EEN <strong>{een_id}</strong>, <strong>{titolo} </strong>è stata presa in carico dallo staff ART-ER EEN, che darà seguito appena possibile.<br>
                                <br>"
