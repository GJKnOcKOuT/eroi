...
<div class="row">
    <div class="col-lg-6">
        <label><?= AmosEen::t('amoseen', 'La tua manifestazione d’interesse sarà presa in carico dallo staff Enterprise Europe Network di ART-ER') ?></label>
    </div>
</div>
...
<!--    < ?=// Html::tag('p', AmosAdmin::t('amosadmin', '#cookie_policy_content')) ?>-->
    ...
    ])->label(Html::a(AmosEen::t('amoseen', 'Prendi visione delle modalità operative dello svolgimento del servizio e accetta per continuare'), '/site/modalitaoperativeeen', ['title' => AmosEen::t('amoseen', '#privacy_label_1'), 'target' => '_blank'])); ?>
