...
class FileModule extends AmosModule
{
    ...
    public $controllerNamespace = 'arter\amos\attachments\controllers';
    ...
    public function attachFile($filePath, $owner, $attribute = 'file', $dropOriginFile = true, $saveWithoutModel = false, $encrypt = false)
    {
        ...
        $tableNameOwner = null;
        if($owner instanceof \arter\amos\core\record\RecordDynamicModel && method_exists($owner, 'getTableName')){
