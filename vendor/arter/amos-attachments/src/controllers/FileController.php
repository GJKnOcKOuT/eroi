...
use arter\amos\attachments\models\EmptyContentModel;
use arter\amos\attachments\models\File;
use arter\amos\attachments\models\FileRefs;
use arter\amos\attachments\models\search\FileSearch;
use arter\amos\core\module\BaseAmosModule;
use arter\amos\core\utilities\SortModelsUtility;
use arter\amos\core\utilities\ZipUtility;
use Yii;
...
class FileController extends Controller
{
    ...
    protected function checkAccess($rule, $action)
    {
        ...
        //Provvisorio
        if ($modelClass == \arter\amos\core\record\RecordDynamicModel::className() && \Yii::$app->user->can('ADMIN')) {
            return true;
        }
    ...
    {
        $module = \arter\amos\attachments\FileModule::getInstance();
    ...
    public function actionExportByQuery()
    {
        ...
        $this->layout = '@vendor/arter/amos-layout/src/views/layouts/form';
