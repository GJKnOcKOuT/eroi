...
namespace arter\amos\organizzazioni;
...
use arter\amos\organizzazioni\widgets\JoinedOrganizationsWidget;
use arter\amos\organizzazioni\widgets\JoinedOrgParticipantsTasksWidget;
...
class Module extends AmosModule implements OrganizationsModuleInterface, SearchModuleInterface, InvitationExternalInterface
{
     ...
     * @inheritdoc
     */
    public $controllerNamespace = 'arter\amos\organizzazioni\controllers';
    ...
    public $db_fields_translation = [
        ...
        [
            'namespace' => 'arter\amos\organizzazioni\models\ProfiloTipoStruttura',
            'attributes' => ['name'],
            'category' => 'amosorganizzazioni',
        ],
    ];
     ...
     *
     * @var \arter\amos\community\AmosCommunity
     */
