...
class Audit extends Module
{
    ...
    /**
     *
     * @var type If specify these actions will be ignored, usefull to avoid GET, POST etc. Set it via platform configuration
     */
    public $skipActions = [];
    ...
    {
        // To avoid error when called by console scripts
        if (Yii::$app instanceof yii\web\Application) {
            $request = \Yii::$app->request;
            if (in_array($request->method, $this->skipActions)) {
                return false;
            }
        }
