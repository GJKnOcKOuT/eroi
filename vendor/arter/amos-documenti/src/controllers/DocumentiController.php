 ...
 * @property \arter\amos\documenti\models\search\DocumentiSearch $modelSearch
 *
 * @package arter\amos\documenti\controllers
 */
...
//                    ],
    ...
    public function sendNotificationEmail()
    {
        ...
        foreach ($idGroupsToMail as $idGroup) {
            $group = \arter\amos\groups\models\Groups::findOne($idGroup);
            if ($group) {
                $members = $group->groupsMembers;
                /** @var  $member \arter\amos\groups\models\GroupsMembers */
...
//                    $community = \arter\amos\community\models\Community::findOne($entityId);
//                    if(!empty($community)) {
