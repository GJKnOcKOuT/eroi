...
class m161130_104913_add_documenti_all_permissions extends AmosMigrationPermissions
{
    ...
    protected function setAuthorizations()
    {
        $this->authorizations = [
            ...
            [
                'name' => arter\amos\documenti\widgets\icons\WidgetIconDocumentiDashboard::className(),
                'type' => Permission::TYPE_PERMISSION,
            ...
            [
                'name' => arter\amos\documenti\widgets\graphics\WidgetGraphicsUltimiDocumenti::className(),
                'type' => Permission::TYPE_PERMISSION,
            ...
            [
                'name' => arter\amos\documenti\widgets\icons\WidgetIconDocumentiCategorie::className(),
                'type' => Permission::TYPE_PERMISSION,
            ...
            [
                'name' => arter\amos\documenti\widgets\icons\WidgetIconDocumentiCreatedBy::className(),
                'type' => Permission::TYPE_PERMISSION,
