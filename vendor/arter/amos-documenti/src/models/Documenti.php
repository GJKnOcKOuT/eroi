...
use arter\amos\core\interfaces\ModelDocumentInterface;
use arter\amos\core\interfaces\ModelImageInterface;
use arter\amos\core\interfaces\ViewModelInterface;
use arter\amos\core\interfaces\WorkflowMetadataInterface;
use arter\amos\core\views\toolbars\StatsToolbarPanels;
use arter\amos\documenti\AmosDocumenti;
use arter\amos\documenti\i18n\grammar\DocumentsGrammar;
use arter\amos\documenti\i18n\grammar\FoldersGrammar;
 ...
 *
 * @property \arter\amos\documenti\models\Documenti[] $allParents
 * @property \arter\amos\documenti\models\Documenti[] $allDocumentVersions
 * @property string $versionInfo
 *
 * @package arter\amos\documenti\models
 */
class Documenti extends \arter\amos\documenti\models\base\Documenti implements ContentModelInterface, CommentInterface, ViewModelInterface, WorkflowMetadataInterface, ModelDocumentInterface, ModelImageInterface
{
    // Workflow ID
...
//            ],
    ...
    public function getStatusToRenderToHide()
    {
        ...
        if (\Yii::$app->getModule('community')) {
            $isCommunityManager = \arter\amos\community\utilities\CommunityUtil::isLoggedCommunityManager();
