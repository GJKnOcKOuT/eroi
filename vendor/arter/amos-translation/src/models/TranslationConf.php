 ...
 */
class TranslationConf extends \arter\amos\core\record\Record
{
    public $id_translate;
    public $language_id;
    ...
    public static function getTranslateContents($params = null)
    {
        ...
        $activeQuery = (new \yii\db\Query())->from(\arter\amos\translation\models\TranslationConf::tableName())
        ...
        $columns[] = [
            ...
            'value' => function ($model) {
                ...
                if (!empty($moduleAdmin)) {
                    $userProfile        = \arter\amos\admin\AmosAdmin::instance()->createModel('UserProfile');
