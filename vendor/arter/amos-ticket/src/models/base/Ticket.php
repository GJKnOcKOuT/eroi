 ...
 * @property \arter\amos\organizzazioni\models\Profilo|\arter\amos\core\interfaces\OrganizationsModelInterface $partnership
 * @property \arter\amos\ticket\models\TicketCategorie $forwardedFromTicket
 * @property \arter\amos\ticket\models\TicketCategorie $nextTicket
 *
 * @package arter\amos\ticket\models\base
 */
class Ticket extends Record
{
    ...
    public function rules()
    {
        ...
        $rules = [
            ...
            [['ticket_categoria_id'], 'exist', 'skipOnError' => true, 'targetClass' => \arter\amos\ticket\models\TicketCategorie::className(), 'targetAttribute' => ['ticket_categoria_id' => 'id']],
        ];
    ...
    {
        return $this->hasOne(\arter\amos\ticket\models\Ticket::className(), ['id' => 'forwarded_from_id']);
    }
    ...
    {
        return $this->hasOne(\arter\amos\ticket\models\Ticket::className(), ['forwarded_from_id' => 'id']);
    }
}
