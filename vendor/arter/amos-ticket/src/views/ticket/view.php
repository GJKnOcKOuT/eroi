...
use arter\amos\ticket\widgets\forms\ByAtWidget;
use yii\helpers\Html;
use yii\helpers\Url;

/**
 * @var yii\web\View $this
 * @var arter\amos\ticket\models\Ticket|WorkflowLogFunctionsBehavior $model
 */
                ...
                <div class="container-sidebar">
                    <div class="last-answer box">
                        ...
                        foreach ($lastComments as $lastComment) {
                            ...
                            /** @var \arter\amos\admin\models\UserProfile $lastCommentUser */
