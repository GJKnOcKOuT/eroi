...
use arter\amos\discussioni\rules\DeleteFacilitatorOwnDiscussioniRule;
use arter\amos\discussioni\rules\DeleteOwnDiscussioniRule;
use arter\amos\discussioni\rules\UpdateFacilitatorOwnDiscussioniRule;
use arter\amos\discussioni\rules\UpdateOwnDiscussioniCommentiRule;
use arter\amos\discussioni\rules\UpdateOwnDiscussioniRule;
use arter\amos\discussioni\rules\UpdateOwnDiscussioniRisposteRule;
use arter\amos\discussioni\rules\DeleteOwnDiscussioniCommentiRule;
use arter\amos\discussioni\rules\DeleteOwnDiscussioniRisposteRule;
...
class m160912_145059_add_discussioni_permission extends AmosMigration
{
    ...
    private function setWidgetsPermissions()
    {
        return [
            [
                'name' => arter\amos\discussioni\widgets\icons\WidgetIconDiscussioniTopicCreatedBy::className(),
                'type' => Permission::TYPE_PERMISSION,
            ...
            [
                'name' => arter\amos\discussioni\widgets\icons\WidgetIconDiscussioni::className(),
                'type' => Permission::TYPE_PERMISSION,
            ...
            [
                'name' => arter\amos\discussioni\widgets\graphics\WidgetGraphicsUltimeDiscussioni::className(),
                'type' => Permission::TYPE_PERMISSION,
            ...
            [
                'name' => arter\amos\discussioni\widgets\graphics\WidgetGraphicsDiscussioniInEvidenza::className(),
                'type' => Permission::TYPE_PERMISSION,
