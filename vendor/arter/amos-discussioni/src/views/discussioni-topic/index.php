...
use arter\amos\discussioni\widgets\DiscussionsCarouselWidget;

/**
 * @var yii\web\View $this
 * @var yii\data\ActiveDataProvider $dataProvider
 * @var arter\amos\discussioni\models\search\DiscussioniTopicSearch $model
    ...
    'buttons' => [
        ...
        'update' => function ($url, $model) {
            if (Yii::$app->user->can('DISCUSSIONITOPIC_UPDATE', ['model' => $model])) {
                ...
                $options = \arter\amos\core\utilities\ModalUtility::getBackToEditPopup(
                    $model,
                    'DiscussionValidate',
                    $action,
                ...
                return Html::a(
                    \arter\amos\core\icons\AmosIcons::show('edit'),
                    $action,
                    $options
                );
            }
