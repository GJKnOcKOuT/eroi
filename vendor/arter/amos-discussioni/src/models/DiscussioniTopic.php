...
use arter\amos\discussioni\i18n\grammar\DiscussionTopicGrammar;
use arter\amos\discussioni\models\base\DiscussioniTopic as DiscussioniTopicBase;
 ...
 *
 * @property \arter\amos\admin\models\UserProfile $lastCommentUser
 * @property \arter\amos\comments\models\Comment $lastComment
 * @property string $lastCommentDate
 * @property \arter\amos\comments\models\Comment[] $lastComments
 */
class DiscussioniTopic extends DiscussioniTopicBase implements ContentModelInterface, CommentInterface, ViewModelInterface, ModelImageInterface
{
    ...
    /**
     * @param \arter\amos\discussioni\models\DiscussioniRisposte $risposta
     * @return ActiveQuery
...
//            ],
    ...
    public function commentsUsersAvatars()
    {
        ...
        $query = Comment::find()
            ->andWhere(['context_id' => $this->id, 'context' => \arter\amos\discussioni\models\DiscussioniTopic::className()])
            ->groupBy(['created_by'])
            ->limit(4);
