...
use arter\amos\chat\models\search\ConversationQuery;
 ...
 *
 * @property-read \arter\amos\chat\models\Message $lastMessage
 * @property-read \arter\amos\chat\models\Message[] $newMessages
 */
class Conversation extends Record
{
    ...
    public static function unread($userId, $contactId)
    {
        ...
        $message = \arter\amos\chat\models\Message::find()
    ...
    {
        return \arter\amos\chat\models\Message::tableName();
    }
    ...
    {
        return $this->hasOne(\arter\amos\chat\models\Message::className(), ['id' => 'last_message_id']);
    }
    ...
    {
        return $this->hasMany(\arter\amos\chat\models\Message::className(), ['sender_id' => 'contact_id', 'receiver_id' => 'user_id'])
