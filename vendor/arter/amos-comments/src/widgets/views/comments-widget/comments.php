 ...
 * @var \arter\amos\comments\models\Comment[] $comments
 * @var \arter\amos\comments\models\CommentReply[] $commentReplies
...
<div id="comments_anchor" class="comment_content col-xs-12">
    ...
    <?php if (!empty($comments)) : ?>
        ...
        <div class="subtitle-comments">
            ...
            <div class="subtitle-text-container">
                <?php if( !$isEnableCommentNotificationAuthUser ) : ?>

                    <a class="icon-link-black" href="<?= "/comments/comment/enable-comment-notification-user" ?>" title="Disabilita le notifiche">
                    ...
                    <a href="<?= "/comments/comment/enable-comment-notification-user" ?>" title="Disabilita le notifiche"> <?= AmosComments::t('amoscomments', '#able-notify-link') ?></a>

                <?php else : ?>

                    <a class="icon-link-black" href="<?= "/comments/comment/disable-comment-notification-user" ?>" title="Abilita le notifiche">
                    ...
                    <a href="<?= "/comments/comment/disable-comment-notification-user" ?>" title="Abilita le notifiche"> <?= AmosComments::t('amoscomments', '#disable-notify-link') ?></a>
                <?php endif; ?>
    ...
    <?php foreach ($comments as $comment): ?>
        <?php /** @var \arter\amos\comments\models\Comment $comment */ ?>
        <div class="answer col-xs-12 nop media">
            ...
            <?php foreach ($commentReplies as $commentReply): ?>
                <?php /** @var \arter\amos\comments\models\CommentReply $commentReply */
                ?>
