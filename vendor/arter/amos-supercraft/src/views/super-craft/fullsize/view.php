            ...
            <div class="post-footer col-xs-12 nop">
                <div class="post-info col-xs-12">
                    <div class="published-by">
                        <div class="item">
                            <label><?= $model->getAttributeLabel('facilitator_text') ?>:</label> <?= $model->facilitator_text ?>
                        </div>
                        <div class="item">
                            <label><?= $model->getAttributeLabel('facilitator_organization_text') ?>:</label> <?= $model->facilitator_organization_text ?>
                        </div>
                        <div class="item">
                            <label><?= $model->getAttributeLabel('users_text') ?>:</label> <?= $model->users_text ?>
                        </div>
                        <div class="item">
