 ...
 * @package arter\amos\best\practice\widgets\icons
 */
class WidgetIconSuperCraftAdminAll extends WidgetIcon
{
    /**
     * @inheritdoc
     */
    ...
    {
        parent::init();
        $this->setLabel(Module::tHtml('supercraft', 'Admin All'));
        $this->setDescription(Module::t('supercraft', 'Admin All'));
        $this->setIcon('linentita');
        $this->setUrl(['/bestpractice/best-practice/admin-all']);
        $this->setCode('SUPER_CRAFT_ADMIN_ALL');
