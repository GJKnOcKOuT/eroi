 ...
 * @property \arter\amos\upload\models\FilemanagerMediafile $immagineNews
 *
 * @package arter\amos\news\models\base
 */
abstract class News extends ContentModel
{
    ...
    {
        return $this->hasOne(\arter\amos\upload\models\FilemanagerMediafile::className(), ['id' => 'immagine']);
    }
}
