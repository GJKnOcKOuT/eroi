...
use arter\amos\comuni\controllers\util\XlsUtil;
...
class ImportatoreController extends Controller {
  ...
  protected function loadFileData($filename, $type = false) {
    $file = \Yii::getAlias(
      '@vendor/arter/amos-comuni/src/file_import/'
      . $filename
    );
  ...
  protected function generateMigrationFile($nome_migration, $type_migration_skel = 'update', $table_name, $new_data, $restore_data) {
    ...
    switch ($type_migration_skel) {
      case 'update':
        $path_migration_skel = \Yii::getAlias('@vendor/arter/amos-comuni/src/views/importatore/importatore_migration_skel/MigrationUpdate.php');
        break;
      case 'insert':
        $path_migration_skel = \Yii::getAlias('@vendor/arter/amos-comuni/src/views/importatore/importatore_migration_skel/MigrationInsert.php');
        break;
    }
