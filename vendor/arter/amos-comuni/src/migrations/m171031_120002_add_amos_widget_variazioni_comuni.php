...
class m171031_120002_add_amos_widget_variazioni_comuni extends AmosMigrationWidgets
{
    ...
    protected function initWidgetsConfs()
    {
        $this->widgets = [
            [
                'classname' => \arter\amos\comuni\widgets\icons\WidgetIconVariazioniComuni::className(),
                'type' => AmosWidgets::TYPE_ICON,
                'module' => self::MODULE_NAME,
                //the widget is visible ONLY for second level dashboard 'comuni'
                'dashboard_visible' => 0,
                'child_of' => \arter\amos\comuni\widgets\icons\WidgetIconVariazioniComuni::className(),
            ]
        ];
    }
}