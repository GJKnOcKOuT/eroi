...
class m171031_160002_add_amos_widget_importatore_codici_catastali extends AmosMigrationWidgets
{
    ...
    protected function initWidgetsConfs()
    {
        $this->widgets = [
            [
                'classname' => \arter\amos\comuni\widgets\icons\WidgetIconImportatoreCodiciCatastali::className(),
                'type' => AmosWidgets::TYPE_ICON,
                'module' => self::MODULE_NAME,
                //the widget is visible ONLY for third level dashboard 'comuni'
                'dashboard_visible' => 0,
                'child_of' => \arter\amos\comuni\widgets\icons\WidgetIconImportatoreCodiciCatastali::className(),
            ]
        ];
    }
}