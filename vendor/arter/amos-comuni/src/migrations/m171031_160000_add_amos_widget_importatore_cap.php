...
class m171031_160000_add_amos_widget_importatore_cap extends AmosMigrationWidgets
{
    ...
    protected function initWidgetsConfs()
    {
        $this->widgets = [
            [
                'classname' => \arter\amos\comuni\widgets\icons\WidgetIconImportatoreCap::className(),
                'type' => AmosWidgets::TYPE_ICON,
                'module' => self::MODULE_NAME,
                //the widget is visible ONLY for second level dashboard 'comuni'
                'dashboard_visible' => 0,
                'child_of' => \arter\amos\comuni\widgets\icons\WidgetIconImportatoreCap::className(),
            ]
        ];
    }
}