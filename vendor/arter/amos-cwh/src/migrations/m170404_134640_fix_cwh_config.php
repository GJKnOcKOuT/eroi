...
from `community`';
    const CLASSNAME_COMMUNITY = 'arter\amos\community\models\Community';
...
1 AS `cwh_config_id`,
`enti`.`id` AS `record_id`,
\'arter\\\\amos\\\\organizzazioni\\\\models\\\\Enti\' AS `classname`,
1 AS `visibility`,
`enti`.`created_at` AS `created_at`,
`enti`.`updated_at` AS `updated_at`,
`enti`.`deleted_at` AS `deleted_at`,
...
from `enti`';
    const CLASSNAME_ENTI_ORG = 'arter\amos\organizzazioni\models\Enti';
