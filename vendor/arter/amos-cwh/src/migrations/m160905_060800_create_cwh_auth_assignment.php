...
//            $this->addForeignKey('fk_user_id', self::TABLE, 'user_id', \arter\amos\core\user\User::tableName() , 'id');
//            $this->addForeignKey('fk_cwh_nodi_id', self::TABLE, 'cwh_nodi_id', \arter\amos\cwh\models\CwhNodi::tableName() , 'id');
            return true;
        } else {
