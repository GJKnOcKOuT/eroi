...
namespace arter\amos\cwh;

use arter\amos\core\module\AmosModule;
use arter\amos\core\record\Record;
use arter\amos\core\user\User;
use arter\amos\cwh\base\ModelNetworkInterface;
use arter\amos\cwh\components\bootstrap\CheckConfigComponent;
use arter\amos\cwh\models\base\CwhConfigContents;
...
use arter\amos\cwh\models\CwhTagInterestMm;
...
class AmosCwh extends AmosModule implements BootstrapInterface
{
     ...
     * @var string
     */
    public $controllerNamespace = 'arter\amos\cwh\controllers';
    /**
     * @var string
     */
    public $postKey = 'Cwh';
    ...
    public $userProfileClass = 'arter\admin\models\UserProfile';

    public $behaviors = [
        'cwhBehavior' => 'arter\amos\cwh\behaviors\CwhNetworkBehaviors'
    ];
        ...
        try {
            ...
            if(isset($moduleTag)){
                $models = ArrayHelper::merge($models, [
                    \arter\amos\tag\models\EntitysTagsMm::className(),
