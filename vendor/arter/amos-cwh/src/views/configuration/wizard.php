...
//                },
    ...
    <div class="row">
        ...
        <div class="bk-btnFormContainer col-sm-12">
            <?= \arter\amos\core\helpers\Html::a(AmosCwh::t('amoscwh', 'Chiudi'),
                Yii::$app->urlManager->createUrl('dashboard'), [
                    'class' => 'btn btn-secondary pull-left',
                    'name' => 'close',
                ]) ?>
            <?= \arter\amos\core\helpers\Html::submitButton(AmosCwh::t('amoscwh', 'Salva'), [
                'class' => 'btn btn-primary pull-right',
                'name' => 'save_config',
            ]) ?>
            <?= \arter\amos\core\helpers\Html::submitButton(AmosCwh::t('amoscwh', 'Ricarica'), [
