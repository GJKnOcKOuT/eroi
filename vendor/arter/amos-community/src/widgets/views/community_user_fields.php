        ...
        <?php if (!empty($dynamicModel->attributesTypes[$attribute])) { ?>
            ...
            <?php } else if ($dynamicModel->attributesTypes[$attribute] == 'file') { ?>
                <div class="col-lg-6 col-sm-6">
                    ...
                    <?php
                    echo $form->field($modelFieldImages, 'attachFiles')->widget(\arter\amos\attachments\components\AttachmentsInput::classname(), [
            ...
            <?php } else if ($dynamicModel->attributesTypes[$attribute] == 'html') { ?>
                <div class="col-lg-12 col-sm-12">
                    <?= $form->field($dynamicModel, $attribute)->widget(\arter\amos\core\forms\TextEditorWidget::className(), [
                        'clientOptions' => [
