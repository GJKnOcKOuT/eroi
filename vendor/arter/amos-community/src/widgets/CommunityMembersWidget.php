        ...
        $itemsMittente = [
            'Photo' => [
                ...
                'value' => function ($model) {
                    /** @var \arter\amos\community\models\CommunityUserMm $model */
...
//                        echo $this->render('@vendor/arter/amos-community/src/views/community/change-user-role', ['model' => $model]);
                                Modal::end();
...
//                            Yii::$app->urlManager->createUrl($createUrlParamsRole), ['class' => 'btn btn-primary font08']);
                ...
                'deleteRelation' => function ($url, $model) {
                    ...
                    $community = \arter\amos\community\models\Community::findOne($model->community_id);
