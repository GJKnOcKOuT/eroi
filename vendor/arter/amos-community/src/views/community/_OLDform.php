...
use arter\amos\core\forms\PublishedContentsWidget;
    ...
    <div class="profile row nom">
        <div class="col-sm-4 col-md-3 col-xs-12 left-column">
            <div class="img-profile">
                <?= $form->field($model, 'communityLogo')->widget(\arter\amos\attachments\components\AttachmentsInput::classname(), [
...
//                            'limiter' => 500
                    ...
                    <?php if(!$fixedCommunityType): ?>
                        <div class="col-sm-6">
                            <?= $form->field($model, 'community_type_id')->widget(Select2::className(), [
                                'data' => CommunityUtil::translateArrayValues(ArrayHelper::map(\arter\amos\community\models\CommunityType::find()->asArray()->all(), 'id', 'name')),
            ...
            <div class="body">
                ...
                <?php
                if (!$model->isNewRecord) {
                    echo \arter\amos\community\widgets\SubcommunitiesWidget::widget([
                        'model' => $model,
                        'isUpdate' => true
                    ]);
                }
            ...
            ?>
            <?= \arter\amos\workflow\widgets\WorkflowTransitionButtonsWidget::widget([
                ...
                'closeButton' => \arter\amos\core\helpers\Html::a(Yii::t('amoscommunity', 'Annulla'), Yii::$app->session->get('previousUrl'), ['class' => 'btn btn-secondary']),
                ...
                'draftButtons' => [
                    Community::COMMUNITY_WORKFLOW_STATUS_DRAFT => [
                        'button' => $model->isNewRecord ?
                            \arter\amos\core\helpers\Html::submitButton(Yii::t('amoscommunity', 'Crea'), ['class' => 'btn btn-workflow']) :
                            \arter\amos\core\helpers\Html::submitButton(Yii::t('amoscommunity', 'Salva'), ['class' => 'btn btn-workflow']),
                    ...
                    'default' => [
                        'button' => \arter\amos\core\helpers\Html::submitButton(Yii::t('amoscommunity', 'Salva'), [
