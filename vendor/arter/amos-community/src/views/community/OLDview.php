    ...
    <div class="profile">
        <div class="col-sm-4 col-md-3 col-xs-12 left-column">
            <div class="img-profile">
                ...
                <div class="under-img">
                    <?= \arter\amos\community\widgets\JoinCommunityWidget::widget(['model' => $model, 'isProfileView' => true]) ?>
                    <h2><?= $model->name ?></h2>
                </div>
            </div>
        </div>
        <div class="col-sm-8 col-md-9 col-xs-12 right-column">
            ...
            <div class="col-xs-12">
                ...
                if (!$model->isNewRecord) {
                    echo \arter\amos\core\forms\editors\m2mWidget\M2MWidget::widget([
                        'model' => $model,
                        'modelId' => $model->id,
            ...
            <?php if ($showTags): ?>
                ...
                <div class="col-xs-12">
                    ...
                    <?php
                    echo \arter\amos\core\forms\ShowUserTagsWidget::widget([
            ...
            <div class="col-xs-12">
                ...
                <?=
                \arter\amos\community\widgets\SubcommunitiesWidget::widget([
                    'model' => $model,
                    'isUpdate' => false
                ]);
                ?>
