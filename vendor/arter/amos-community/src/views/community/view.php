...
use arter\amos\community\widgets\CommunityPublishedContentsWidget;
use arter\amos\community\widgets\JoinCommunityWidget;
use arter\amos\community\widgets\mini\CommunityMembersMiniWidget;
use arter\amos\community\widgets\SubcommunitiesWidget;
...
<div class="community-view col-xs-12 nop">
    ...
    <div class="col-md-8 col-xs-12">
        ...
        <div class="widget-body-content col-xs-12 nop">
            <?php echo \arter\amos\report\widgets\ReportDropdownWidget::widget([
                'model' => $model,
            ])
            ?>
        </div>
