 ...
 * @property \arter\amos\core\user\User $partnerOf
 *
...
class CommunityUserMm extends Record
{
    ...
    public function rules()
    {
        return [
            ...
            [['invitation_partner_of'], 'exist', 'skipOnError' => true, 'targetClass' => \arter\amos\core\user\User::className(), 'targetAttribute' => ['invitation_partner_of' => 'id']],
        ];
    }
    ...
    {
        return $this->hasOne(\arter\amos\core\user\User::className(), ['id' => 'invitation_partner_of']);
    }
}
