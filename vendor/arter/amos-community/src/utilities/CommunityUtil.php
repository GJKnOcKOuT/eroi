...
class CommunityUtil
{
    ...
    public static function getAllCommunityManagerRoles()
    {
        ...
        foreach ($contexts as $context) {
            $context = '\\' . $context;
            /** @var \arter\amos\community\models\CommunityContextInterface $model */
            $model = new $context();
    ...
    public static function canDeleteCommunity($community)
    {
        ...
        if (!$communityModule->deleteCommunityWithContents) {
            ...
            if (!is_null($cwhModule)) {
                ...
                $communityContents = \arter\amos\cwh\utility\CwhUtil::getNetworkContents(Community::getCwhConfigId(), $community->id);
