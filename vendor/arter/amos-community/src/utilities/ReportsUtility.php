 ...
 *
 * @package    arter\amos\community\utilities
...
use arter\amos\community\models\CommunityReport;
...
class ReportsUtility extends BaseObject
{
    ...
    /**
     * @var null|\arter\amos\cwh\AmosCwh $cwhModule
     */
    private $cwhModule;
    
    /**
     * @var null|\arter\amos\documenti\AmosDocumenti $documentsModule
     */
    ...
    public function uploadedFileSizesByCommunity($community)
    {
        ...
        $documentsClassName = \arter\amos\documenti\models\Documenti::className();
        ...
        $cwhConfigContentDocuments = \arter\amos\cwh\models\CwhConfigContents::findOne(['classname' => $documentsClassName]);
...
//    }
    ...
    {
        $query_cm = \arter\amos\community\models\CommunityUserMm::find()->select('user_id');
        /** @var ActiveQuery $query */
        $query = UserProfile::find();
