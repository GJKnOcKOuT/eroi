    ...
    echo AmosGridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'format' => 'html',
                'value' => function($model) {
                    $allWidgets    = \arter\amos\dashboard\models\search\AmosWidgetsSearch::getAllSubdashWidgets(\arter\amos\dashboard\models\AmosWidgets::TYPE_ICON,
                            false, $model['id']);
                    $widgetsToShow = [];
            ...
            [
                ...
                'format' => 'html',
                'value' => function($model) {
                    $allWidgets    = \arter\amos\dashboard\models\search\AmosWidgetsSearch::getAllSubdashWidgets(\arter\amos\dashboard\models\AmosWidgets::TYPE_GRAPHIC,
                            false, $model['id']);
                    $widgetsToShow = [];
