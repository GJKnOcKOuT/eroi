...
namespace arter\amos\dashboard\controllers\base;

use arter\amos\core\controllers\AmosController;
 ...
 * @package arter\amos\dashboard\controllers\base
 */
    ...
    protected function setUserWidgets($widgets)
    {
        ...
        if (!empty($widgets) && is_array($widgets)) {
            foreach ($widgets as $widget) {
                if ($widget->type == \arter\amos\dashboard\models\AmosWidgets::TYPE_GRAPHIC) {
