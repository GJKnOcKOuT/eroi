                            ...
                            if ($value->classname != 'arter\amos\admin\widgets\icons\WidgetIconUserProfile' &&
                                ...
                                (
                                    empty(\Yii::$app->params['isPoi']) || (!empty(\Yii::$app->params['isPoi']) && \Yii::$app->params['isPoi']
                                        == false) || $this->model->className() != \arter\amos\community\models\Community::className()
                                    || ($value->classname != \arter\amos\projectmanagement\widgets\icons\WidgetIconprojects::className()
                                        /* && $value->classname !=  \arter\amos\documenti\widgets\icons\WidgetIconDocumentiDashboard::className() */)
                                    || ($value->classname == \arter\amos\projectmanagement\widgets\icons\WidgetIconprojects::className()
