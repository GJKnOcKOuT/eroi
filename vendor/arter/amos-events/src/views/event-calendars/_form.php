            ...
            <div class="col-md-12 col xs-12">
                ...
                <?php if ($model->event_id) { ?>
                    <div class="col-xs-12 nop m-t-20">
                        <p>
                            <strong><?= \arter\amos\events\AmosEvents::t('amosevents', 'Event') ?></strong>: <?= $event->title ?>
                        </p>
                    </div>
                <?php } else { ?>
                    <?= $form->field($model, 'event_id')->widget(Select::classname(), [
                        'data' => ArrayHelper::map(\arter\amos\events\models\Event::find()->asArray()->all(), 'id', 'title'),
                    ...
                    ])->label(\arter\amos\events\AmosEvents::t('amosevents', 'Event'));
                }
                ?>
                <!-- title string -->
...
<!--                </div>-->
                ...
                <div class="col-xs-12 nop">
                    <div class="col-xs-6 nop">
                        <?php
                        $partner = '';
                        $userProfilePartner = \arter\amos\admin\models\UserProfile::find()->andWhere(['user_id' => $model->partner_user_id])->one();
