...
<div class="col-xs-12">
        ...
        <div class="centered-details col-xs-12">
            <div class="row">
                <section>
                    ...
                    <?= \arter\amos\events\widgets\EventsPublishedByWidget::widget([
                    ...
                    //                    echo\arter\amos\core\forms\PublishedByWidget::widget([
                    //                        'model' => $model,
    ...
    <?php
    echo \arter\amos\core\forms\WizardPrevAndContinueButtonWidget::widget([
        'model' => $model,
