...
use arter\amos\core\forms\editors\socialShareWidget\SocialShareWidget;
...
use arter\amos\events\widgets\CommunityEventMembersWidget;
...
//                        ],
        ...
        <?php
        $modelSearch = new \arter\amos\events\models\search\EventCalendarsSlotsSearch();
    ...
    <?php if ($model->seats_management && EventsUtility::hasPrivilegesLoggedUser($model)) { ?>
        ...
        <div class="attachments col-xs-12 nop">
            ...
            $totEmptySeats = $model->getEventSeats()
                ->andWhere(['status' => [EventSeats::STATUS_EMPTY, \arter\amos\events\models\EventSeats::STATUS_TO_REASSIGN]])->count();
            ?>
