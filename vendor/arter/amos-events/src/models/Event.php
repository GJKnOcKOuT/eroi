...
use arter\amos\events\i18n\grammar\EventGrammar;
 ...
 * @package arter\amos\events\models
 */
class Event extends \arter\amos\events\models\base\Event implements ContentModelInterface, CommunityContextInterface,
    ...
    public function beforeDelete()
    {
        if (!is_null($this->begin_date_hour)) {
            ...
            if (!is_null($socialAuth)) {
                ...
                $services = \arter\amos\socialauth\models\SocialAuthServices::find()->andWhere([
                        'and',
                        ['service' => 'calendar'],
                        ['not', ['service_id' => null]]
                    ])->all();
