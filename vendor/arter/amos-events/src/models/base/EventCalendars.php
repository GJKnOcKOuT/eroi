 ...
 */
class  EventCalendars extends \arter\amos\core\record\Record
{
    ...
    public function rules()
    {
        return [
            ...
            [['event_id'], 'exist', 'skipOnError' => true, 'targetClass' => \arter\amos\events\models\Event::className(), 'targetAttribute' => ['event_id' => 'id']],
        ];
    }
    ...
    {
        return $this->hasOne(\arter\amos\events\models\Event::className(), ['id' => 'event_id']);
    }
    ...
    {
        return $this->hasMany(\arter\amos\events\models\EventCalendarsSlots::className(), [ 'event_calendars_id' => 'id']);
    }
