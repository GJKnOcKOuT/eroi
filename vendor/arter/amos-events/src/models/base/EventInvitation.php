 ...
 */
class EventInvitation extends \arter\amos\core\record\Record
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            [['partner_of'], 'exist', 'skipOnError' => true, 'targetClass' => \arter\amos\core\user\User::className(), 'targetAttribute' => ['partner_of' => 'id']],
        ];
    }
