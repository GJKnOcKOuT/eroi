...
use arter\amos\events\validators\CapValidator;
 ...
 *
 * @property \arter\amos\events\models\EventType $eventType
 * @property \arter\amos\admin\models\UserProfile $users
 * @property \arter\amos\comuni\models\IstatComuni $cityLocation
 * @property \arter\amos\comuni\models\IstatProvince $provinceLocation
 * @property \arter\amos\comuni\models\IstatNazioni $countryLocation
 * @property \arter\amos\events\models\EventMembershipType $eventMembershipType
 * @property \arter\amos\events\models\EventLengthMeasurementUnit $eventLengthMeasurementUnit
...
abstract class Event extends ContentModel implements CommunityInterface
{
    ...
    public function init()
    {
        ...
        if ($this->isNewRecord) {
            ...
            $this->event_membership_type_id = \arter\amos\events\models\EventMembershipType::TYPE_OPEN;
    ...
    {
        return $this->hasOne(\arter\amos\comuni\models\IstatComuni::className(), ['id' => 'city_location_id']);
    }
    ...
    {
        return $this->hasOne(\arter\amos\comuni\models\IstatProvince::className(), ['id' => 'province_location_id']);
    }
    ...
    {
        return $this->hasOne(\arter\amos\comuni\models\IstatNazioni::className(), ['id' => 'country_location_id']);
    }
    ...
    {
        return $this->hasMany(\arter\amos\events\models\EventCalendars::className(), [ 'event_id' => 'id']);
    }
}
