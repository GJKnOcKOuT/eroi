...
use arter\amos\events\models\EventLengthMeasurementUnit;
use arter\amos\events\models\EventParticipantCompanion;
use arter\amos\events\models\EventParticipantCompanionDynamic;
use arter\amos\events\models\EventSeats;
use arter\amos\events\models\EventType;
use arter\amos\events\models\FormAssignSeat;
use arter\amos\events\models\RegisterGroupForm;
use arter\amos\events\rules\EventsCheckInRule;
use arter\amos\events\rules\EventsUpdateRule;
use arter\amos\events\utility\EventsUtility;
use arter\amos\events\utility\ICS;
use arter\amos\events\utility\MultipleModel;
use kartik\mpdf\Pdf;
...
class EventController extends base\EventController
{
     ...
     * @see \arter\amos\events\models\EventInvitationsUpload::parse()
     */
    ...
    {
        $path = Yii::getAlias('@vendor').'/arter/amos-events/src/downloads';
    ...
    public function actionViewSector($id)
    {
        ...
        if (!is_null($resetScope) && ($resetScope == 1)) {
            ...
            if (isset($cwhModule)) {
                /** @var \arter\amos\cwh\AmosCwh $cwhModule */
