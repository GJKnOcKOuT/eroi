...
use arter\amos\events\rules\DeleteOwnEventsRule;
use arter\amos\events\rules\UpdateOwnEventsRule;
...
class m170315_135901_init_events_permissions extends AmosMigrationPermissions
{
    ...
    private function setWidgetsPermissions()
    {
        ...
        return [
            [
                'name' => \arter\amos\events\widgets\icons\WidgetIconEvents::className(),
                'type' => Permission::TYPE_PERMISSION,
            ...
            [
                'name' => \arter\amos\events\widgets\icons\WidgetIconEventTypes::className(),
                'type' => Permission::TYPE_PERMISSION,
            ...
            [
                'name' => \arter\amos\events\widgets\icons\WidgetIconEventsCreatedBy::className(),
                'type' => Permission::TYPE_PERMISSION,
            ...
            [
                'name' => \arter\amos\events\widgets\icons\WidgetIconEventsManagement::className(),
                'type' => Permission::TYPE_PERMISSION,
