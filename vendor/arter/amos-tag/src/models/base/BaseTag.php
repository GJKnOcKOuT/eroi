 ...
 *
 * @package    arter\amos\tag\models\base
 ...
 * @property \arter\amos\tag\models\EntitysTagsMm[] $entitysTagsMms
 *
 * @package arter\amos\tag\models\base
 */
class BaseTag extends Tree
{
    ...
    {
        return $this->hasMany(\arter\amos\admin\models\UserProfile::className(),
    ...
    {
        return $this->hasMany(\arter\amos\tag\models\TagModelsAuthItemsMm::className(),
    ...
    public function getCwhTagInterestMm()
    {
        ...
        if (isset($moduleCwh)) {
            return $this->hasMany(\arter\amos\cwh\models\CwhTagInterestMm::className(),
                ['tag_id' => 'id'])->inverseOf('tag');
        }
        return null;
    }
    ...
    {
        return $this->hasMany(\arter\amos\tag\models\EntitysTagsMm::className(), ['tag_id' => 'id']);
    }
}
