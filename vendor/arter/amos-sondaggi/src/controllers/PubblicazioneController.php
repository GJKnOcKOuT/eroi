...
use arter\amos\sondaggi\assets\ModuleRisultatiAsset;
...
//                foreach ($domandeWithFilesModels as $doma
				...
				//	pr($idSessione); die;
                    ...
                    $this->addFlash('success',
                            AmosSondaggi::tHtml('amossondaggi', 'Bozza salvata con successo'));
...
//                foreach ($domandeWithFilesModels as $doma
     ...
     *//* TODO TODO TODO TODO TODO TODO TODO TODO TODO
      ...
      $this->layout = '@vendor/arter/amos/core/views/layouts/sondaggio';
      $this->model = new \arter\amos\sondaggi\models\SondaggiPubblicazione();
      ...
      $verificaSondaggio = \arter\amos\sondaggi\models\SondaggiPubblicazione::find()->leftJoin(Sondaggi::tableName(), 'id = sondaggi_id')->andWhere(['tipologie_attivita' => $idTipologia])->andWhere(['sondaggi_stato_id' => 3])->andWhere(['ruolo' => 'PUBBLICO'])->orderBy('sondaggi_id DESC');
                                            ...
                                            $attivita = null, $inizio = false, $libero = false)
    {
        ...
        if ($libero && $id) {
            $verificaSondaggio = \arter\amos\sondaggi\models\SondaggiPubblicazione::find()->innerJoin(Sondaggi::tableName(),
    ...
    {
        $this->layout = '@vendor/arter/amos/core/views/layouts/sondaggio';
        $models       = \arter\amos\sondaggi\models\SondaggiPubblicazione::find()->innerJoin(Sondaggi::tableName(),
        ...
        if ($id) {
            $verifica = \arter\amos\sondaggi\models\SondaggiPubblicazione::find()->innerJoin(Sondaggi::tableName(),
                    'id = sondaggi_id')->andWhere(['id' => $id])->andWhere(['tipologie_attivita' => 0])->andWhere(['status' => Sondaggi::WORKFLOW_STATUS_VALIDATO])->andWhere([
                'ruolo' => 'PUBBLICO']);
            if ($verifica->count() == 1) {
...
//                    pr(implode(',', $risposteArray), 'D. ' . $domanda->id);
    ...
    {
        $content = $this->renderPartial('@vendor/arter/amos-sondaggi/src/views/sondaggi/_view_pdf',
            [
            'data' => $data,
