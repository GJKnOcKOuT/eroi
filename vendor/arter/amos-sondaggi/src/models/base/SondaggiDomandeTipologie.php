 ...
 */
class SondaggiDomandeTipologie extends \arter\amos\core\record\Record {
    ...
    public function getSondaggiDomandes() {
        return $this->hasMany(\arter\amos\sondaggi\models\SondaggiDomande::className(), ['sondaggi_domande_tipologie_id' => 'id'])
