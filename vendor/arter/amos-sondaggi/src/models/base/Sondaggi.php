 ...
 *
 * @property \arter\amos\upload\models\FilemanagerMediafile $filemanagerMediafile
 * @property \arter\amos\sondaggi\models\SondaggiStato $sondaggiStato
 * @property \arter\amos\sondaggi\models\SondaggiTemi $sondaggiTemi
 * @property \arter\amos\sondaggi\models\SondaggiDomande[] $sondaggiDomandes
 * @property \arter\amos\sondaggi\models\SondaggiDomandePagine[] $sondaggiDomandePagines
 * @property \arter\amos\sondaggi\models\SondaggiRisposteSessioni[] $sondaggiRisposteSessionis
 * @property \arter\amos\sondaggi\models\SondaggiPubblicazione[] $sondaggiPubblicaziones
 *
 * @package arter\amos\sondaggi\models\base
 */
abstract class Sondaggi extends ContentModel
{
    ...
    'updated_by', 'deleted_by', 'version', 'send_pdf_via_email', 'frontend', 'abilita_registrazione', 'mail_registrazione_custom', 'mail_conf_community', 'mail_conf_community_id', 'abilita_criteri_valutazione', 'n_max_valutatori', 'sondaggio_chiuso_frontend', 'visualizza_solo_titolo'], 'integer'],
...
{
    return $this->hasOne(\arter\amos\upload\models\FilemanagerMediafile::className(),
...
{
    return $this->hasOne(\arter\amos\sondaggi\models\SondaggiStato::className(), ['id' => 'sondaggi_stato_id']);
}
...
{
    return $this->hasOne(\arter\amos\sondaggi\models\SondaggiTemi::className(), ['id' => 'sondaggi_temi_id']);
}
...
{
    return $this->hasMany(\arter\amos\sondaggi\models\SondaggiDomande::className(), ['sondaggi_id' => 'id'])->andWhere([
            \arter\amos\sondaggi\models\SondaggiDomande::tableName().'.deleted_at' => null]);
}
...
{
    return $this->hasMany(\arter\amos\sondaggi\models\SondaggiDomandePagine::className(),
            ['sondaggi_id' => 'id'])
...
{
    return $this->hasMany(\arter\amos\sondaggi\models\SondaggiRisposteSessioni::className(),
            ['sondaggi_id' => 'id']);
}
...
{
    return $this->hasMany(\arter\amos\sondaggi\models\SondaggiPubblicazione::className(),
            ['sondaggi_id' => 'id']);
}
