 ...
 *
 * @package    arter\amos\sondaggi\models\search
...
/**
 * SondaggiSearch represents the model behind the search form about `arter\amos\sondaggi\models\Sondaggi`.
 */
...
//        $query->andWhere(['NOT IN', 'id', $sondaggiAccessi]);
    ...
    public function cmsSearch($params, $limit): \arter\amos\core\interfaces\ActiveDataProvider
    {
