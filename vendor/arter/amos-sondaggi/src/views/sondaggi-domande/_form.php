...
use yii\helpers\Url;
use arter\amos\sondaggi\models\SondaggiMap;
        ...
        <?php if ($model->sondaggi_id) : ?>
            ...
            <div class="col-xs-12">
                ...
                $form->field($model, 'ordina_dopo')->widget(DepDrop::classname(),
                    ...
                    'data' => $model->getDomandaPrecedente() ? [$model->getDomandaPrecedente() => arter\amos\sondaggi\models\SondaggiDomande::findOne($model->getDomandaPrecedente())->domanda]
                            : [],
    ...
    <div class="row sondaggio-row">
        <div class="col-lg-6 col-sm-6">
            ...
            $form->field($model, 'sondaggi_domande_tipologie_id')->dropDownList(
                \yii\helpers\ArrayHelper::map(\arter\amos\sondaggi\models\SondaggiDomandeTipologie::find()->andWhere([
    ...
    <div class="row" id="abilita-ordinamento-risposte">
        ...
        <div class="col-lg-6">
            ...
            $form->field($model, 'validazione')->widget(Select2::classname(),
                [
                'data' => ArrayHelper::map(\arter\amos\sondaggi\models\SondaggiDomandeRule::find()->orderBy('nome')->asArray()->all(),
                    'id', 'nome'),
                'options' => [
    ...
    <div class="row" id="selezione-modello">
        <div class="col-lg-12 col-sm-12">
            ...
            $form->field($model, 'modello_risposte_id')->widget(Select2::classname(),
                [
                'data' => ArrayHelper::map(\arter\amos\sondaggi\models\SondaggiModelliPredefiniti::find()->orderBy('classname')->asArray()->all(),
                    'id', 'classname'),
                'options' => [
                    'placeholder' => AmosSondaggi::t('amossondaggi', 'Seleziona ...'),
                    'id' => 'modello-id',
        ...
        <div class="col-lg-6 col-sm-6">
            ...
            if ($model->sondaggi_id) :
                ...
                $form->field($model, 'sondaggi_id')->widget(Select2::classname(),
                    [
                    'data' => ArrayHelper::map(\arter\amos\sondaggi\models\Sondaggi::find()->asArray()->all(),
                        'id', 'titolo'),
