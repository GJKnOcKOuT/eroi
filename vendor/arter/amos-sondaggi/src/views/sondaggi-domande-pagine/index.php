 ...
 * @var \arter\amos\sondaggi\models\search\SondaggiDomandePagineSearch $searchModel
 */
...
if ($url) {
    ...
    if (filter_input(INPUT_GET, 'idSondaggio')) {
        $this->title = AmosSondaggi::t('amossondaggi', 'Pagine del sondaggio') . ': ' . arter\amos\sondaggi\models\Sondaggi::findOne(['id' => filter_input(INPUT_GET, 'idSondaggio')])->titolo;
    }
}
                ...
                [
                    ...
                    'buttons' => [
                        'update' => function ($url, $model) {
                            /** @var \arter\amos\sondaggi\models\search\SondaggiDomandePagineSearch $model */
