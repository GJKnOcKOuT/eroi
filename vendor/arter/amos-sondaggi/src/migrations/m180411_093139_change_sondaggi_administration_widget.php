...
class m180411_093139_change_sondaggi_administration_widget extends AmosMigrationWidgets
{
    ...
    protected function initWidgetsConfs()
    {
        $this->widgets = [
            [
                'classname' => \arter\amos\sondaggi\widgets\icons\WidgetIconSondaggiAdministration::className(),
            ...
            [
                'classname' => 'arter\amos\sondaggi\widgets\icons\WidgetIconSondaggiAdministration',
                'update' => true,
