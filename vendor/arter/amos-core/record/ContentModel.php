...
use arter\amos\core\i18n\grammar\ContentModelGrammar;
    ...
    public function behaviors() {
        ...
        if (\Yii::$app->getModule('attachments')) {
            $behaviors['fileBehavior'] = [
                'class' => \arter\amos\attachments\behaviors\FileBehavior::className()
            ];
        }
        if ($this->isSearch) {
...
//            }
    ...
    {
        Event::on(
            \arter\amos\core\widget\WidgetIcon::className(),
            \arter\amos\core\widget\WidgetIcon::EVENT_AFTER_COUNT,
