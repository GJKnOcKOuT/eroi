...
use arter\amos\core\toolbar\Nav;
use arter\amos\core\toolbar\NavBar;
        ...
        $settings = [
            ...
            'items' => [
                ...
                [
                    ...
                    'visible' => (\Yii::$app->controller instanceof arter\amos\dashboard\controllers\base\DashboardController),
                    'options' =>
                        [
                            'class' => 'enable_order',
