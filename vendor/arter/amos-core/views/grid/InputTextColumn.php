...
class InputTextColumn extends Column {

    /**
     * Nome del campo che sarà mappato con l'input text
     */
    public $name;
    ...
    protected function renderDataCellContent($model, $key, $index) {
        if ($this->content === null) {
            return '<input type="text" name="' . $model->{$this->name} . '" value="' . $this->value[$model->{$this->name}] . '" />';
        } else {
            return '<input type="text" name="' . $model->{$this->name} . '" value="' . $this->value[$model->{$this->name}] . '" />';
        }
    }
