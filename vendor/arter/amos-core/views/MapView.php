...
use arter\amos\core\views\MapAmos;
...
//        $this->map    = new MapAmos($mapConfig);
    ...
    public function run()
    {
        ...
        if (!empty($moduleL)) {
            \arter\amos\layout\assets\AmosMapAsset::register($this->getView());
        } else {
            \arter\amos\core\views\assets\AmosMapAsset::register($this->getView());
        }
