 ...
 *
 * @package    arter\amos\core\views\common
 * @category   CategoryName
 * @author     Elite Division S.r.l.
 */

namespace arter\amos\core\views\common;
...
class BaseListView extends ListView
{
    ...
    protected function initMasonry()
    {
        ...
        if (!empty($moduleL)) {
            \arter\amos\layout\assets\MasonryAsset::register($view);
        } else {
            \arter\amos\core\views\assets\MasonryAsset::register($view);
        }
