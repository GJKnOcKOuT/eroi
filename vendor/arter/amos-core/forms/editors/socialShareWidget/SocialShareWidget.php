 ...
 *
 * @package    arter\amos\core\forms\editors\socialShareWidget
 * @category   CategoryName
 * @author     Elite Division S.r.l.
 */

namespace arter\amos\core\forms\editors\socialShareWidget;

use arter\amos\core\components\ConfiguratorSocialShare;
        ...
        if ($this->isProtected == true && !empty($cwhModule) && $model instanceof ContentModelInterface && in_array(get_class($model),
            ...
            if (!empty($destinatari)) {
                ...
                foreach ($destinatari as $regola) {
                    ...
                    $cwh_nodi = \arter\amos\cwh\models\CwhNodi::findOne($regola);
                    // if the content is inside an OPEN type community,  you can share the content
                    if (!empty($cwh_nodi)) {
                        $ClassnameNetwork = $cwh_nodi->classname;
                        if ($ClassnameNetwork == "arter\amos\community\models\Community") {
