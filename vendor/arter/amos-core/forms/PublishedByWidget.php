...
class PublishedByWidget extends Widget
{
    ...
    {
        $content = \arter\amos\cwh\utility\CwhUtil::getPublicationRuleLabel($this->model->regola_pubblicazione);
    ...
    public function renderTargetAdv()
    {
        ...
        $publicationRule = \arter\amos\cwh\utility\CwhUtil::getPublicationRuleLabel($this->model->regola_pubblicazione);
