...
use arter\amos\core\forms\EmailForm;
...
use arter\amos\core\utilities\DuplicateContentUtility;
 ...
 * @property \arter\amos\core\record\Record $modelSearch
 *
 * @package arter\amos\core\controllers
 */
abstract class CrudController extends BaseController
{
    ...
    public function actionRequestInformation($id)
    {
        ...
        $view = '@vendor/arter/amos-core/forms/views/information_request';
        ...
        if (Yii::$app->getRequest()->isAjax && Yii::$app->request->isPost) {
            ...
            if ($infoRequest->load($post) && $infoRequest->validate($post)) {
                ...
                if (!is_null($fromUser)) {
                    ...
                    $templatePath = !empty($infoRequest->templatePath) ? $infoRequest->templatePath : '@vendor/arter/amos-core/views/email/request-information';
     ...
     * @throws \arter\amos\core\exceptions\DuplicateContentException
