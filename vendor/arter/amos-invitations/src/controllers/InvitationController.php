...
namespace arter\amos\invitations\controllers;

use arter\amos\admin\AmosAdmin;
use arter\amos\invitations\models\GoogleInvitationForm;
use arter\amos\invitations\models\Invitation;
use arter\amos\invitations\models\InvitationUser;
use arter\amos\invitations\models\UserToInvite;
use arter\amos\invitations\Module;
use arter\amos\invitations\utility\InvitationsUtility;
use Yii;
...
class InvitationController extends base\InvitationController
{
    ...
    {
        $view = '@vendor/arter/amos-invitations/src/widgets/views/invite-user';
