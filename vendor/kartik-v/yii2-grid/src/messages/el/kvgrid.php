...
return [
    ...
    'All' => 'Όλα',
    'Are you sure to delete this {item}?' => 'Είσαι σίγουρος για την διαγραφή του {item}?',
    ...
    'Total <b>{count, number}</b> {count, plural, one{{item}} other{{items}}}.' => 'Συνολικά <b>{count, number}</b> {count, plural, one{{item}} few{{items-few}} many{{items-many}} other{{items}}}.',
    'Update' => 'Ενημέρωση',
    'View' => 'Προβολή',
    'export' => 'εξαγωγή',
    'grid-export' => 'εξαγωγή πίνακα',
