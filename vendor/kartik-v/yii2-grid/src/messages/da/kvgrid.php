...
return [
    ...
    'Active' => 'Aktiv',
    'Add Book' => 'Tilføj Bog',
    'Are you sure to delete this {item}?' => 'Er du sikker på at du vil slette dette {item}?',
    ...
    'Showing <b>{begin, number}-{end, number}</b> of <b>{totalCount, number}</b> {totalCount, plural, one{{item}} other{{items}}}.' => 'Viser <b>{begin, number}-{end, number}</b> af <b>{totalCount, number}</b> {totalCount, plural, one{{item}} few{{items-few}} many{{items-many}} other{{items}}}.',
    'Text' => 'Tekst',
