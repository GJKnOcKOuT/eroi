...
return [
    ...
    'Showing <b>{begin, number}-{end, number}</b> of <b>{totalCount, number}</b> {totalCount, plural, one{{item}} other{{items}}}.' => '<b>{totalCount, number}</b> {totalCount, plural, one{{item}} few{{items-few}} many{{items-many}} other{{items}}} <b>{begin, number}-{end, number}</b> arası göstərilir.',
    'Total <b>{count, number}</b> {count, plural, one{{item}} other{{items}}}.' => 'Toplam <b>{count, number}</b> {count, plural, one{{item}} few{{items-few}} many{{items-many}} other{{items}}}.',
    'item' => 'elementdən',
    'items' => 'elementdən',
