...
return [
    ...
    'Failed to update editable data due to an unknown server error' => 'No se ha podido actualizar el dato debido a un error del servidor.',
    'Generated' => 'Generado',
    ...
    'Inactive' => 'Inactivo',
    'Invalid editable index or model form name' => 'Índice o nombre de módelo no válido',
    'Invalid or bad editable data' => 'Datos no válidos',
    'JSON' => 'JSON',
    ...
    'No valid editable model found' => 'No se ha encontrado un modelo editable válido',
