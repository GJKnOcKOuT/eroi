...
return [
    ...
    'Showing <b>{begin, number}-{end, number}</b> of <b>{totalCount, number}</b> {totalCount, plural, one{{item}} other{{items}}}.' => 'ნაჩვენებია ჩანაწერები <b>{begin, number}-{end, number}</b> из <b>{totalCount, number}</b> {totalCount, plural, one{{item}} few{{items-few}} many{{items-many}} other{{items}}}.',
    'Total <b>{count, number}</b> {count, plural, one{{item}} other{{items}}}.' => 'სულ <b>{count, number}</b> {count, plural, one{{item}} few{{items-few}} many{{items-many}} other{{items}}}.',
    'item' => 'ჩანაწერი',
    'items' => 'ჩანაწერი',
    'items-few' => 'ჩანაწერი',
    'items-many' => 'ჩანაწერი',
