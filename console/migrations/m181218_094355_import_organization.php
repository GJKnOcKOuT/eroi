 ...
 */
class m181218_094355_import_organization extends Migration
{
    /**
     * @return bool|void
    ...
    {
        $this->insert('profilo_types_pmi', ['id' => 14, 'name' => 'Laboratorio Rete Alta Tecnologia']);
        $this->insert('profilo_legal_form', ['id' => 16, 'name' => 'Altro']);
...
//        pr($organization->attributes);
        $placeId = $this->saveAddress($rowData[5], $rowData[6], $rowData[7],  $rowData[8], $rowData[9] );
        if($placeId) {
