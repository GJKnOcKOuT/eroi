...
return [
    ...
    'translatemanager' => [
        ...
        // IMPORTANT: for detailed instructions read the chapter about root configuration.
            'layout' => '@vendor/arter/amos-core/views/layouts/main',             // Name of the used layout. If using own layout use 'null'.
            'allowedIPs' => ['*'],      // IP addresses from which the translation interface is accessible.
            'roles' => ['ADMIN', 'TRANSLATION_ADMINISTRATOR'],               // For setting access levels to the translating interface.
