...
class SiteController extends Controller {
     ...
     * @return string
     */
    public function actionModalitaoperativeeen()
    {
        return $this->render('modalitaoperativeeen');
    }
    ...
    /**
     * Method to view the terms of use
     *
     * @return void
     */
    public function actionTerminiUso(){
