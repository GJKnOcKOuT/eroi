...
*
    ...
    */
class TagTranslation extends \arter\amos\core\record\Record
{
...
return [
            ...
            [['tag_id'], 'exist', 'skipOnError' => true, 'targetClass' => \arter\amos\tag\models\Tag::className(), 'targetAttribute' => ['tag_id' => 'id']],
