...
*
    ...
    */
class DocumentiCategorieTranslation extends \arter\amos\core\record\Record
{
...
return [
            ...
            [['documenti_categorie_id'], 'exist', 'skipOnError' => true, 'targetClass' => \arter\amos\documenti\models\DocumentiCategorie::className(), 'targetAttribute' => ['documenti_categorie_id' => 'id']],
...
'language_source' => \Yii::t('amostranslation', 'Select another source language'),
    ...
    */
    ...
    {
    return $this->hasOne(\arter\amos\documenti\models\DocumentiCategorie::className(), ['id' => 'documenti_categorie_id']);
    }
}
