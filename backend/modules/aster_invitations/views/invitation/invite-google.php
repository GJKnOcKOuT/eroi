...
use arter\amos\invitations\assets\InvitationsAsset;
use yii\widgets\Pjax;

InvitationsAsset::register($this);
/**
 * @var yii\web\View $this
 * @var \arter\amos\invitations\models\GoogleInvitationForm $invitationForm
...
<div class="invite-google col-xs-12 nop">
    ...
    <div class="col-xs-12 nop">
        <?= $form->field($invitationForm, 'message')->widget(\arter\amos\core\forms\TextEditorWidget::className(), [
            'clientOptions' => [
