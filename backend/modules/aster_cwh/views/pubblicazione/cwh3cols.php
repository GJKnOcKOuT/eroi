 ...
 *
 * @package    backend\modules\aster_cwh\views\pubblicazione
...
<?php
$recipientsDescriptionTab = Module::t('amospartnershipprofiles', '#partnership_profiles_recipients_tab_description');

if(!empty($recipientsDescriptionTab)):
    ?>  <div class="recipients tab-form-description">
    <?= $recipientsDescriptionTab ?>
</div>
<?php endif; ?>
