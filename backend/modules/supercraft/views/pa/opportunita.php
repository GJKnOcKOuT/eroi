        ...
        'columns' => [
            ...
            ['class' => 'yii\grid\ActionColumn',
                'urlCreator' => function ($action, $model, $key, $index) {
                    if ($action === 'view') {
                        $url = 'view?id_processo_aziendale=' . $model['id_processo_aziendale'];
                        return $url;
                    }

                    if ($action === 'update') {
                        $url = 'update?id_processo_aziendale=' . $model['id_processo_aziendale'];
                        return $url;
                    }
                    if ($action === 'delete') {
                        $url = 'delete?id_processo_aziendale=' . $model['id_processo_aziendale'];
                        return $url;
                    }
                    return null;
                }
