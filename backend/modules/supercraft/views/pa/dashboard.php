        ...
        'columns' => [
            ...
            ['class' => 'yii\grid\ActionColumn',
                'urlCreator' => function ($action, $model, $key, $index) {
                    if ($action === 'view') {
                        $url = 'eroi/supercraft/pa/view?id_processo_aziendale=' . $model;
                        return $url;
                    }

                    if ($action === 'update') {
                        $url = 'eroi/supercraft/pa/update?id_processo_aziendale=' . $model;
                        return $url;
                    }
                    if ($action === 'delete') {
                        $url = 'eroi/supercraft/pa/delete?id_processo_aziendale=' . print_r($model);
                        return $url;
                    }
                }
            ],
