 ...
 *
 * @package    backend\modules\aster_community\views\community
 * @category   CategoryName
 * @author     Elite Division S.r.l.
 */

use arter\amos\community\widgets\mini\CommunityMembersMiniWidget;
use arter\amos\community\widgets\mini\SubcommunitiesMiniWidget;
...
use backend\modules\aster_community\assets\AsterCommunityAsset;
...
AsterCommunityAsset::register($this);
    ...
    <div class="row">
        ...
        <div class="col-md-8 col-xs-12">
            ...
            <?php if (!$fixedCommunityType || ($showSubcommunityField && $showSubcommunities)): ?>
                <div class="col-xs-12 flex-row end-alignment">
                    <div class="col-md-6 col-xs-12">
                        <?php if (!$fixedCommunityType): ?>
                            <?= $form->field($model, 'community_type_id', [
                                    'template' => "{label}\n{hint}\n{beginWrapper}\n{input}\n{error}\n{endWrapper}",
                            ...
                            ])->label($model->getAttributeLabel('communityType'),
                                ['for' => 'communityType' . $model->id]
                            )->hint(AmosCommunity::t('amoscommunity', "#community_type_description")); ?>
                        <?php endif; ?>
                    </div>
                    <div class="col-md-6 col-xs-12">
            ...
            AccordionWidget::widget([
                'items' => [
                    [
                        ...
                        'content' => \arter\amos\community\widgets\ConfigureDashboardCommunityWidget::widget(['model' => $model]),
                    ]
                ],
                'headerOptions' => ['tag' => 'h2'],
                'clientOptions' => [
