...
<div>
    <div style="box-sizing:border-box;">
        ...
        <div
            ...
            <h2 style="font-size:2em;line-height: 1;"><?= $util->userName . " " . AmosCommunity::t('amoscommunity', '#rejected_invitation_mail_text_1') . " " . lcfirst($util->community->getGrammar()->getModelSingularLabel()) ?></h2>
