...
<div>
    <div style="box-sizing:border-box;">
        ...
        <div
            ...
            <h2 style="color:#000000;font-size:2em;line-height: 1;"><?= AmosCommunity::t('amoscommunity', '#change_role_mail_text_1') . " " . lcfirst($util->community->getGrammar()->getModelSingularLabel()) ?></h2>
