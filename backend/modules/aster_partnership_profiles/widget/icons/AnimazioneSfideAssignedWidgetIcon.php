...
class AnimazioneSfideAssignedWidgetIcon extends WidgetIcon
{
    ...
    public function init()
    {
        ...
        $this->setLabel(Module::tHtml('amospartnershipprofiles', 'Assegnate'));
        ...
        $this->setUrl(['/partnershipprofiles/partnership-profiles/animation-assigned']);
