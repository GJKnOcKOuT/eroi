...
class AnimazioneSfideToAssignWidgetIcon extends WidgetIcon
{
    ...
    public function init()
    {
        ...
        $this->setLabel(Module::tHtml('amospartnershipprofiles', 'Da assegnare'));
        ...
        $this->setUrl(['/partnershipprofiles/partnership-profiles/animation-to-assign']);
