...
class AnimazioneSfidePublishedWidgetIcon extends WidgetIcon
{
    ...
    public function init()
    {
        ...
        $this->setLabel(Module::tHtml('amospartnershipprofiles', 'Pubblicate'));
        ...
        $this->setUrl(['/partnershipprofiles/partnership-profiles/animation-published']);
