...
use backend\modules\aster_core\forms\ItemAndCardHeaderWidget;
    ...
    <div class="<?= Yii::$app->controller->id ?> post-horizonatal">
        <div class="post-header media nop col-xs-12 col-sm-7">
            <?= ItemAndCardHeaderWidget::widget([
                ...
                'creatorAvatarLinkOptions' => $itemAndCardCreatorLinkOptions,
                'creatorNameLinkOptions' => $itemAndCardCreatorLinkOptions
            ]) ?>
        </div>
