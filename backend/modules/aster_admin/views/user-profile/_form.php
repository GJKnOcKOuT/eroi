...
use backend\modules\aster_core\forms\Tabs;
use arter\amos\admin\AmosAdmin;
use arter\amos\admin\assets\AmosAsset;
...
use arter\amos\privileges\widgets\UserPrivilegesWidget;
...
<div class="user-form col-xs-12">
    ...
    <div class="tabsHeader">
        <?= Html::tag('h2', AmosAdmin::t('amosadmin', '#settings_details_title'), ['class' => 'subtitle-form']) ?>
        <?= Html::tag('div', AmosAdmin::t('amosadmin', '#settings_details_descr'), ['class' => 'description-form']) ?>
    </div>
                ...
                <div>
                    ...
                    <?php else: ?>
                        ...
                        if ($enableUserContacts && $model->validato_almeno_una_volta) {
                            echo \arter\amos\admin\widgets\UserContacsWidget::widget([
                                'userId' => $model->user_id,
                                'isUpdate' => true
                            ]);
                        }
                        if (isset($moduleCwh)) {
                            echo \arter\amos\cwh\widgets\UserNetworkWidget::widget([
                                'userId' => $model->user_id,
                                'isUpdate' => true
                            ]);
                        }
    ...
    <div class="row">
        ...
        <div class="col-xs-12 note_asterisk">
            <?= AmosAdmin::t('amosadmin', '#reserved_fields_description'); ?>
        </div>
    ...
    <?php if ($userCanChangeWorkflow) { ?>
        ...
        <div class="row">
            ...
            if (Yii::$app->user->can('ADMIN') || Yii::$app->user->can('AMMINISTRATORE_UTENTI') || Yii::$app->user->can(ValidateUserProfileWorkflowRule::className(), ['model' => $model])) {
                echo \arter\amos\workflow\widgets\WorkflowTransitionButtonsWidget::widget([
                ...
                echo \arter\amos\workflow\widgets\WorkflowTransitionSimplifiedButtonsWidget::widget([
                    'form' => $form,
                    'model' => $model,
                    'workflowId' => UserProfile::USERPROFILE_WORKFLOW,
                    'viewWidgetOnNewRecord' => true,
...
//            'id' => 'modalExitFormId',
//            'modalDescriptionText' => AmosAdmin::t('amosadmin', '#leave-message-description'),
//            'cancelBtnLabel' => AmosAdmin::t('amosadmin', 'Annulla'),
//            'confirmBtnLabel' => AmosAdmin::t('amosadmin', 'Ok'),
//            'confirmBtnOptions' => [
...
//        ]);
        ModalUtility::createAlertModal([
            'id' => 'modalExitFormId',
            'modalDescriptionText' => AmosAdmin::t('amosadmin', '#leave-message-description-stop'),
            'btnLabel' => AmosAdmin::t('amosadmin', 'Ok'),
        ]);
    }
    ?>
    <div class="leave-message hidden">
        <?= AmosAdmin::t('amosadmin', '#leave-message-description') ?>
    </div>
</div>
